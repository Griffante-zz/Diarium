	...
	public function actionCreate()
	{
		...
		if(isset($_POST['secretario']) && isset($_POST['user']))
		{
			...
			if($model->validate() && $user->validate()){
				...
				$model->id = $user->id; // Pegando o ID do usuário cadastrado, e vinculado ao id da tabela Secretario
			
				if($model->save())//Salvando os dados do Secretário com o ID do Usuário
